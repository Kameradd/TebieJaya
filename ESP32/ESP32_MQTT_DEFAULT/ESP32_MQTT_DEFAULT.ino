...
// WiFi credentials
const char *ssid = "Cantika";             // Replace with your WiFi name
const char *password = "cantikaacantik";   // Replace with your WiFi password
...
const long gmt_offset_sec = 7 * 3600;            // GMT offset in seconds (adjust for your time zone)
...
void connectToMQTT() {
    espClient.setCACert(ca_cert);  // load CA cert
